...
type confirmationCodeScreenProps = NativeStackScreenProps<RootStackParamList, 'AUTH'>;

const confirmationCodeScreen: React.FC<confirmationCodeScreenProps> = ({navigation}) => {
